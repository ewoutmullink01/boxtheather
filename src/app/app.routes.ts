...
import { TheaterShowcaseComponent } from './features/theater-showcase/theater-showcase';

export const routes: Routes = [
  { path: '', pathMatch: 'full', redirectTo: 'home' },
  { path: 'home', component: Home, data: { title: 'Home' } },
  { path: 'agenda', component: StaticPageComponent, data: { title: 'Agenda' } },
  { path: 'kaartverkoop', component: TheaterShowcaseComponent, data: { title: 'Kaartverkp' } },
